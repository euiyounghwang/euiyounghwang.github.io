...
- <i>Platform : Build & create local environment & tools with docker and python virtualenv and test them using some scripts (<i>https://github.com/euiyounghwang/python-platform-engine/tree/master</i>>)
