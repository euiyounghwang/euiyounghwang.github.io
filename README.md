...
- __<i>Tools (Pycharm, Eclipse, Postman, Spring Boot, VS Code, ELK, Jupyter, Databricks, Datadog, Grafana, Cerebro, Prometheus, AlertManager with Slack alert, Oracle, MongoDB, Postgres, Redis, RabbitMQ, Apache Tomcat, Bonsai for Elasticsearch/Opensearch Cluster, Kibana/Opensearch-dashboard, Jupyter, Google Colab for testing the AI model, Google Search Appliance, Jira/Confluence, Postman/Insomnia for validating restapi, Docker (i.e Docker with Search Engine - <i>https://github.com/euiyounghwang/python-search_engine/blob/master/docker-compose.yml</i>), DockerHub with my account)</i>__
