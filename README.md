...
- Builing FastAPI Framework based on continuous integration and continuous delivery (`CI/CD`, <i>https://github.com/euiyounghwang/python-CICD-fastapi-basic</i>) platform that allows you to automate your build, test, and deployment pipeline by using CircleCI & GitHub Actions with notifications through Slack
