...
- __<i>Platform__ : Build & create local environment & tools such asp Apach Kafka, Prometheus, Grafana an so on with docker and python virtualenv and test them using some scripts (<i>https://github.com/euiyounghwang/python-platform-engine/tree/master</i>>)
