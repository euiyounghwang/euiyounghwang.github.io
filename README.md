...
- Project Leader & AI Engineer to AI POS-ComplAi Project with AI Model based on Supervised Machine Learning Model (News: http://bit.ly/2Ojc7Ij, It requires to translate in English) in South Korea
