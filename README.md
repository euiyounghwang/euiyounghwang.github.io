...
- __<i>Tools (Pycharm, Eclipse, Postman, Spring Boot, VS Code, ELK, Jupyter, Databricks, Datadog, Grafana, Cerebro, Prometheus, AlertManager with Slack alert, Oracle, MongoDB, Postgres, Redis, RabbitMQ, Apache Tomcat, Bonsai for Elasticsearch Cluster, Jupyter, Google Colab for testing the AI model, Google Search Appliance, Jira/Confluence, DockerHub with my account)</i>__
