...
- __<i>Platform Repository__ : Build & create local environment & tools such as Apach Kafka, Rabbitmq, Elasticsearch/Opensearch/Solr, Elasticsearch Curator, Logstash, ELK, Prometheus, Grafana, Builtin-Exporter/Custom-Export for Obserability, Alertmanager, Postgres an so on with docker and python virtualenv and test them using some scripts (<i>https://github.com/euiyounghwang/python-platform-engine/tree/master</i>)
