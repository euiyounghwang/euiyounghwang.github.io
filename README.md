...
- Building _**Django & Django REST Framework (DRF, Swagger with 'drf_yasg')** (<i>https://github.com/euiyounghwang/python-django/tree/master</i>)with Poetry dependency management and Python Virtual Enviroment with Postgres & Elasticsearch : REST API for DB model with CRUD, REST API & Frontend with template for search results
