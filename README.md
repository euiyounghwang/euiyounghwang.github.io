...
- __<i>Tools (Pycharm, Eclipse, Postman, Spring Boot, VS Code, ELK, Jupyter, Databricks, Datadog, Grafana, Cerebro, Prometheus, AlertManager with Slack alert, Oracle, MongoDB, Postgres, Redis, RabbitMQ, Apache Tomcat, Bonsai for Elasticsearch Cluster, Jupyter, Google Colab for testing the AI model, Google Search Appliance, Jira/Confluence, Postman/Insomnia for validating restapi, DockerHub with my account)</i>__
...
- __<i>Programming : Python Web Stacks(Flask, FastAPI, Django) - FastAPI <i>https://github.com/euiyounghwang/python-fastapi-vector-search</i>, Flask-Connexion(<i>https://github.com/euiyounghwang/python-flask-connexion-example-openapi3-master</i>, Django & Django Rest Framework (<i>https://github.com/euiyounghwang/python-django</i>) with Docker&Docker-Compose, Elasticsearch API, Databricks notebook, Java, Spring Boot, Google colab for implementation/testing AI model), Web Stack(Javascript/Jquery, HTML, CSS, XML, ASP), Socket Programming(TCP/UDP)
...
- Monitoring ES Cluaster with our production services by using <i>Grafana, Datadog, Kibana and participating to On-Call Rotation</i>
