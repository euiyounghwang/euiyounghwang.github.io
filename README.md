...
<i>Python Project(FastAPI enviroment) based on Search Engine such as Elasticsearch/Opensearch including docker, pytest, search api service, shell scripts for elasticsearch cluster and performance test environment (https://github.com/euiyounghwang/python-search_engine</i>)
