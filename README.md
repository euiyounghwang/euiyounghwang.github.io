...
- Building Django & Django REST Framework (DRF, Swagger with `'drf_yasg'`) with Poetry dependency management and Python Virtual Enviroment with Postgres & Elasticsearch : <i>REST API for DB model with CRUD, REST API & Frontend with template for search results</i> (<i>https://github.com/euiyounghwang/python-django/tree/master</i>)
