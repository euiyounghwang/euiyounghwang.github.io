...
- Building FastAPI Framework based on continuous integration and continuous delivery (`CI/CD`, <i>https://github.com/euiyounghwang/python-CICD-fastapi-basic</i> and other repos for master/dev/new pull requests branch with slack's notification) platform that allows you to automate your build, test, and deployment pipeline by using CircleCI & GitHub Actions
