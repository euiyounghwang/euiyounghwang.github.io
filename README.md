...
In FiscalNote (2022.07 ~ 2023.07), I contributed  to improve search relevance with complex queries such as func_score to adjust the weight to search results and  query performance with clusters. Through my contribution, the unstable cluster has been stabilized. Also I continuously implement new features for our search services based on Python/Databricks in the Conda/Docker environment. I’d love to build them using a container application, Docker. In more detail, I did the following:
