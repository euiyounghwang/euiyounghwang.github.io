...
<i>Python Project based on Search Engine such as Elasticsearch/Opensearch, FastAPI enviroment including pytest, search api service, shell scripts for elasticsearch cluster and performance test environment (https://github.com/euiyounghwang/python-search_engine</i>)
