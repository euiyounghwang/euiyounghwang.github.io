...
- <i>__Environment__ (Vagrant, Anaconda/Miniconda, Python VirtualEnv/.venv, Golang Env, Docker&Docker-Compose, Poetry, Github, Bash Script, CircleCI/GitHub Actions, Amazon Web Serivice)</i>
...
- __<i>Platform Repository__ : Build tools for creating a docker container in local environment such as Apach Kafka, Rabbitmq, Elasticsearch/Opensearch/Solr, Elasticsearch Curator, Logstash, ELK, Prometheus, Grafana, Builtin-Exporter/Custom-Export for Observability, Alertmanager, Postgres an so on with docker and python virtualenv and test them using some scripts (<i>https://github.com/euiyounghwang/python-platform-engine/tree/master</i>)
